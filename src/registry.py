...
def _build_default_registry() -> ServiceRegistry:
    ...
    transaction_keywords = {
        ...
        '质量问题': ('质量差', '质量问题', '有问题', '坏了', '质量不好', '做工差', '有缺陷', '发霉', '发霉了', '发霉的', '变质', '过期', '破损', '损坏', '开裂', '断裂', '变形', '漏水', '漏油', '异味', '异味重', '色差', '尺寸不符', '材质差', '甲醛', '甲醛味', '气味重', '刺鼻', '有毒', '有害物质', '过敏', '掉色', '褪色', '脱皮', '开胶', '生锈', '划痕', '污渍', '不行', '不好用', '不能用', '用不了', '没法用', '效果不好', '没用', '不太行', '不满意', '差劲', '糟糕'),
